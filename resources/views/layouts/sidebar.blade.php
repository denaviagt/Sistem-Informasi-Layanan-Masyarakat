        ...
        <div class="scroll-sidebar" data-sidebarbg="skin6">
            ...
            <nav class="sidebar-nav" style="overflow: auto !important">
                <ul id="sidebarnav">
                    ...
                    <li id="sidebarService" class="sidebar-item"> <a class="sidebar-link"
                            href="{{ url('service') }}" aria-expanded="false"><i class="fab fa-servicestack"></i><span
                                class="hide-menu">Layanan
                            </span></a>
