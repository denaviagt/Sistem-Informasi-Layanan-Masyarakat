                                        ...
                                        <div class="form-group">
                                            <select class="custom-select @error('status') is-invalid @enderror"
                                                ...
                                                @foreach ($statuses as $key => $status)
                                                    <option value="{{ $key }}" @if ($naturalResource->status == $key) selected @endif>
                                                        {{ $status }}
                                                    </option>
                                                @endforeach
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="ml-2 col-sm-6">
                                            @foreach ($naturalResource->images as $item)
                                                <img src="{{ asset('uploads/images/natural_resource' . $item->images) }}"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group @error('description') is-invalid @enderror">
                                            <textarea class="form-control @error('description') is-invalid @enderror"
                                                ...
                                                rows="15">{{ $naturalResource->description }}</textarea>
                                        </div>
                                        @error('description')
                                            <span class="text-danger">
                                                {{ $message }}
