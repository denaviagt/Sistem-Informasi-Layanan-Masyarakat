                ...
                <div id="smartwizard">
                    ...
                    <div class="tab-content">
                        <div id="step-1" class="tab-pane detail-data-pemohon" role="tabpanel" aria-labelledby="step-1">
                            ...
                            <input type="hidden" name="service_category_id" id="service_category_id" value="{{ $service->service_category_id }}">
                            <div class="row m-3">
                        ...
                        <div id="step-2" class="tab-pane berkas-layanan" role="tabpanel" aria-labelledby="step-2">
                            ...
                            <div class="row m-3">
                                ...
                                <span class="col-4 mr-3 detail-value" name="file-name" id="file-name{{ $files[$key]['id'] ?? '' }}">{{ $files[$key]['file_url'] ?? '' }}</span>
                                <a href="{{ asset('assets/serviceFile/' . $files[$key]['file_url']) }}" class="btn btn-primary mr-3 service-file-btn">Lihat File</a>
                                <button type="button" class="btn btn-success mr-3" id="berkas{{ $files[$key]['id'] ?? '' }}" onclick="statusUpdate(event.target)" data-id="{{ $files[$key]['id'] ?? '' }}">Verifikasi</button>
                                <button type="button" class="btn btn-danger" id="btn-berkas{{ $files[$key]['id'] ?? '' }}" onclick="fileDenied(event.target)" data-id="{{ $files[$key]['id'] ?? '' }}">Tolak</button>
                            </div>
                            @endforeach
                        </div>
